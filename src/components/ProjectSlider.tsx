...
const ProjectSlider: React.FC = () => {
  ...
  // Function to navigate to the new route and remove '#projects'
  const navigateToNewRoute = () => {
    const newRoute = '/projects';
        ...
        >
          <div className="title-container flex flex-col gap-6 mb-24 rotate-3 justify-between items-center max-lg:w-[100vw]">
            ...
            >
              ...
              <h2 className="text-[--white] mb-16" onClick={navigateToNewRoute}>
                {language === "DE" ? "Meine Projekte" : "My Projects"}
              </h2>
              {/* <Button onClick={navigateToNewRoute} label="Live Demo"/> */}
                <h4 onClick={navigateToNewRoute} >See More Projects</h4>
              {/* </Button> */}
